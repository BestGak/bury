...
<main>
    ...
    <div class="container">
        ...
        <div class="autor">
            <?php if ( $author_logo ) : ?>
                <img src="<?php echo esc_url( $author_logo ); ?>" alt="<?php echo esc_attr( $full_name ); ?>">
            <?php else : ?>
                <?php echo get_avatar( $author_id, 120, '', esc_attr( $full_name ) ); ?>
            <?php endif; ?>
            ...
            <div class="autor__info">
                ...
                <?php else : ?>
                    <p><?php printf( __( 'Всього публікацій: %d', 'tyrbota' ), $author_posts_count ); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php else : ?>
            <p><?php _e( 'У цього автора поки що немає публікацій.', 'tyrbota' ); ?></p>
        <?php endif; ?>
    </div>
</main>
<?php get_footer(); ?>